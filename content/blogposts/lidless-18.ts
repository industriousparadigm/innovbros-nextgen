...
export const Lidless18: WorkItem = {
  title: "Lidless Anymore",
  author: "The Innovation Brothers",
  coverImage: "lidless-18-cover.png",
  description:
    "Lidless Anymore (2018) a sealable container with inbuilt flexible lid.",
  content: [
    {
      type: "Paragraph",
      text: "The challenge:",
    ...
    {
      type: "Paragraph",
      text: "Frustratingly, people are routinely unable to find a lid to match their container or lids are lost/damaged. This is because, to save space in kitchen cabinets, people have the container and the lid stored separately.",
    },
    {
      type: "Image",
